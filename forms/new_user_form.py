...
class NewUserForm(forms.Form):
    ...
    pwdEnsure = forms.CharField(
        label="powtórz hasło",
        max_length=50,
        widget=forms.PasswordInput)

    # najpierw są uruchamiane clean_field, a potem clean; można też nie robić
    # clean_field żeby nie trzeba spr form.errors
    ...
    def clean(self):
        ...
        if p1 != p2:
            self.add_error(
                'pwdEnsure',
                'Powtórzone hasło nie jest zgodne z podanym')
        ...
        # zwracamy już bez hasła, bo się nim zajęliśmy
        return {'id': whatid, 'name': n}
