...
SECRET_KEY = "8bf*&a4wq1+t93uqco#f+5_18qhsp54%3lxk9t+b&*cq*@_sw9"
...
MIDDLEWARE = [
    ...
    'clear_old_events.PastEventClearer',
]

ROOT_URLCONF = 'meetingserver.urls'
...
WSGI_APPLICATION = 'meetingserver.wsgi.application'
